let balance = parseInt(document.getElementById("myAccountBalance").innerText);
function sendMoney(){
   ...
   else 
   {
      ...
      var bal = parseInt(document.getElementById("myAccountBalance").innerText) - Amount;
      document.getElementById("myAccountBalance").innerText = bal;
